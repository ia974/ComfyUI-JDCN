...
def copy_it(source_path, destination_dir, overwrite=False):
    try:
...
class JDCN_FileCopier:
    ...
    def make_list(self, FilePaths, OutputDirectory, OverwriteFile):
        ...
        for file in FilePaths:
            copy_it(file, OutputDirectory[0], OverwriteFile[0])
...
N_CLASS_MAPPINGS = {
    "JDCN_FileCopier": JDCN_FileCopier,
}
